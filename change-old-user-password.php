...
if (isset($_POST['change_password'])) {
    ...
    $result = $login->cdp_change_password($_POST['email'], $_POST['password'], $_POST['confirmation_password']);
    if ($result) {
                            ...
                            <div class="col-12">
                                <div class="card login-page border-0" style="z-index: 1">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <p class="text-center">For the security reason please change your password.</p>
                                        ...
                                        <form class="login-form mt-4" method="post" name="login_form">
                                            <div class="row">
                                                <!--end col-->
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="form-icon position-relative">
                                                            ...
                                                            <input type="password" class="form-control ps-5"
                                                                ...
                                                                name="confirmation_password" id="password" required="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                ...
                                                <div class="col-lg-12 mb-0">
                                                    <div class="d-grid">
                                                        ...
                                                        <input name="change_password" type="hidden" value="1" />
                                                    </div>
                                                </div>
                                                <!--end col-->
