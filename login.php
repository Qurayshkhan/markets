                            ...
                            <div class="col-12">
                                <div class="card login-page border-0" style="z-index: 1">
                                    ...
                                    <div class="card-body p-0">
                                        <h4 class="card-title text-center"><?php echo $lang['message_title_login2'] ?>
                                            <?php echo $core->site_name ?>
                                        </h4>
                                        ...
                                        <form class="login-form mt-4" method="post" name="login_form" id="login-form">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        <label class="form-label"><?php echo $lang['left115'] ?> <span
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        <label class="form-label"><?php echo $lang['left117'] ?> <span
                                                                class="text-danger">*</span></label>
                                                        <div class="form-icon position-relative">
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="form-check">
                                                                ...
                                                                <label class="form-check-label"
                                                                    for="flexCheckDefault"><?php echo $lang['left120'] ?></label>
                                                            </div>
                                                        </div>
                                                        <p class="forgot-pass mb-0"><a href="forgot-password.php"
                                                                class="text-dark fw-bold"><?php echo $lang['left119'] ?></a>
                                                        </p>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                ...
                                                <div class="col-lg-12 mb-0">
                                                    <div class="d-grid">
                                                        <button
                                                            class="btn btn-grad"><?php echo $lang['left121'] ?></button>
                                                ...
                                                <div class="col-12 text-center">
                                                    <p class="mb-0 mt-3"><small
                                                            class="text-dark me-2"><?php echo $lang['left122'] ?></small>
                                                        <a href="sign-up.php"
                                                            class="text-dark fw-bold"><?php echo $lang['left123'] ?></a>
                                                    </p>
                                                </div>
                                                <!--end col-->
                                            </div>
                                        ...
                                        <div class="col-lg-12 mt-4 text-center">
                                            ...
                                            <div class="row">
                                                <div class="col-12 mt-3">
                                                    <div class="d-grid">
                                                        <a href="tracking.php" class="btn btn-light"><i
                                                                data-feather="codesandbox"
                                                                class="fea icon-sm icons"></i>
                                                            <?php echo $lang['langs_06'] ?></a>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                            ...
                                            <div class="col-lg-12 mt-4 text-center">
                                                ...
                                                <ul class="list-unstyled social-icon mb-0 mt-3">
                                                    <li class="list-inline-item"><button type="button"
                                                            onclick="$('#username').val('admin'); $('#password').val('09731');"
                                                            class="btn btn-secondary btn-sm mb-3 mr-0">Admin</button></li>
                                                    <li class="list-inline-item"><button type="button"
                                                            onclick="$('#username').val('employee'); $('#password').val('09731');"
                                                            class="btn btn-secondary btn-sm mb-3 mr-0">Employee</button>
                                                    </li>
                                                    <li class="list-inline-item"><button type="button"
                                                            onclick="$('#username').val('customer'); $('#password').val('09731');"
                                                            class="btn btn-secondary btn-sm mb-3 mr-0">Customer</button>
                                                    </li>
                                                    <li class="list-inline-item"><button type="button"
                                                            onclick="$('#username').val('driver'); $('#password').val('09731');"
                                                            class="btn btn-secondary btn-sm mb-3 mr-0">Driver</button></li>
                                                </ul><!--end icon-->
                                            </div>
                                            <!--end col-->
                                            <?php
