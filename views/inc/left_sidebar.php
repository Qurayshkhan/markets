				...
				<ul id="sidebarnav">
					...
					<li>
						...
						<div class="user-profile d-flex no-block dropdown m-t-20">
							<div class="user-pic">
								<img src="assets/<?php echo ($userData->avatar) ? $userData->avatar : "blank.png"; ?>"
					...
					<li class="sidebar-item">
						...
						<ul aria-expanded="false" class="collapse  first-level">
							...
							<li class="sidebar-item">
								<a class="sidebar-link waves-effect waves-dark" href="prealert_list.php"
									aria-expanded="false">
							...
							<li class="sidebar-item">
								<a class="sidebar-link waves-effect waves-dark" href="customer_packages_list.php"
									aria-expanded="false">
									<i class="mdi mdi-adjust" style="color:#fc3f7"></i>
							...
							<li class="sidebar-item">
								<a class="sidebar-link waves-effect waves-dark" href="payments_gateways_list.php"
									aria-expanded="false">
									<i class="mdi mdi-adjust" style="color:#fc3f7"></i>
					...
					<li class="sidebar-item">
						...
						<ul aria-expanded="false" class="collapse  first-level">
							...
							<li class="sidebar-item">
								<a class="sidebar-link waves-effect waves-dark" href="payments_gateways_courier_list.php"
									aria-expanded="false">
									<i class="mdi mdi-adjust" style="color:#fc3f7"></i>
									<span class="hide-menu"><?php echo $lang['left-menu-sidebar-12'] ?> </span>
								</a>
						...
						<ul aria-expanded="false" class="collapse  first-level">
								...
								<ul aria-expanded="false" class="collapse  first-level">
									...
									<li class="sidebar-item">
										<a class="sidebar-link waves-effect waves-dark"
											href="payments_gateways_consolidate_list.php" aria-expanded="false">
											<i class="mdi mdi-adjust" style="color:#fc3f7"></i>
											<span class="hide-menu"><?php echo $lang['left-menu-sidebar-12'] ?> </span>
										</a>
									</li>
							...
							<li class="sidebar-item">
								...
								<ul aria-expanded="false" class="collapse  first-level">
									...
									<li class="sidebar-item">
										<a class="sidebar-link waves-effect waves-dark"
											href="payments_gateways_package_consolidate_list.php" aria-expanded="false">
											<i class="mdi mdi-adjust" style="color:#fc3f7"></i>
											<span class="hide-menu"><?php echo $lang['left-menu-sidebar-12'] ?> </span>
										</a>
									</li>
					...
					<li class="sidebar-item">
						...
						<ul aria-expanded="false" class="collapse  first-level">
							...
							<li class="sidebar-item">
								<a class="sidebar-link waves-effect waves-dark" href="global_payments_gateways.php"
									aria-expanded="false">
									<i class="mdi mdi-adjust" style="color:#fc3f7"></i>
									<span class="hide-menu"><?php echo $lang['left-menu-sidebar-12'] ?> </span>
								</a>
					...
					<li class="sidebar-item">
						...
						<ul aria-expanded="false" class="collapse  first-level">
							<li class="sidebar-item">
								<a class="sidebar-link waves-effect waves-dark" href="customers_list.php"
									aria-expanded="false">
									<i class="mdi mdi-adjust" style="color:#fc3f7"></i>
							...
							<li class="sidebar-item">
								<a class="sidebar-link waves-effect waves-dark" href="recipients_admin_list.php"
					...
					<li class="sidebar-item">
						...
						<ul aria-expanded="false" class="collapse  first-level">
							...
							<li class="sidebar-item">
								<a class="sidebar-link waves-effect waves-dark" href="taxesadnfees.php"
									aria-expanded="false">
									<i class="mdi mdi-adjust" style="color:#fc3f7"></i>
							...
							<li class="sidebar-item">
								<a class="sidebar-link waves-effect waves-dark sidebar-link"
									href="shipping_tariffs_list.php" aria-expanded="false">
									<i class="mdi mdi-adjust" style="color:#fc3f7"></i>
							...
							<li class="sidebar-item">
								<a class="sidebar-link waves-effect waves-dark" href="track_invoice.php"
									aria-expanded="false">
									<i class="mdi mdi-adjust" style="color:#fc3f7"></i>
							...
							<li class="sidebar-item">
								<a class="sidebar-link waves-effect waves-dark" href="info_ship_default.php"
									aria-expanded="false">
									<i class="mdi mdi-adjust" style="color:#fc3f7"></i>
					...
					<li class="sidebar-item">
						...
						<ul aria-expanded="false" class="collapse  first-level">
							...
							<li class="sidebar-item">
								<a class="sidebar-link waves-effect waves-dark sidebar-link" href="payment_mode_list.php"
									aria-expanded="false">
									<i class="mdi mdi-adjust" style="color:#fc3f7"></i>
									<span class="hide-menu"> <?php echo $lang['left-menu-sidebar-40'] ?></span>
								</a>
					...
					<li class="sidebar-item">
						...
						<ul aria-expanded="false" class="collapse  first-level">
							<li class="sidebar-item">
								<a class="sidebar-link waves-effect waves-dark" href="countries_list.php"
									aria-expanded="false">
									<i class="mdi mdi-adjust" style="color:#fc3f7"></i>
							...
							<li class="sidebar-item">
								<a class="sidebar-link waves-effect waves-dark" href="states_list.php"
									aria-expanded="false">
									<i class="mdi mdi-adjust" style="color:#fc3f7"></i>
							...
							<li class="sidebar-item">
								<a class="sidebar-link waves-effect waves-dark" href="cities_list.php"
									aria-expanded="false">
									<i class="mdi mdi-adjust" style="color:#fc3f7"></i>
			...
			<?php } else if ($userData->userlevel == 2) { ?>
					...
					<ul id="sidebarnav">
						...
						<li>
							...
							<div class="user-profile d-flex no-block dropdown m-t-20">
								<div class="user-pic">
									<img src="assets/<?php echo ($userData->avatar) ? $userData->avatar : "uploads/blank.png"; ?>"
										class="rounded-circle" width="50" />
								</div>
								<?php
								date_default_timezone_set("" . $core->timezone . "");
								...
								<div class="user-content hide-menu m-l-10">
									<a href="javascript:void(0)" class="" id="Userdd" role="button" data-toggle="dropdown"
										...
										<span class="op-5 user-email"><?php echo $lang['left-menu-sidebar-0'] ?>:
											<strong><?php echo $userData->name_off; ?></strong></span>
									</a>
								</div>
							</div>
							<!-- End User Profile-->
						...
						<ul id="sidebarnav">
							...
							<!-- <li class="sidebar-item">
								...
								<ul aria-expanded="false" class="collapse  first-level">
									...
									<li class="sidebar-item">
										<a class="sidebar-link waves-effect waves-dark" href="prealert_list.php"
											aria-expanded="false"><i class="mdi mdi-adjust" style="color:#fc3f7"></i>
											<span class="hide-menu"> <?php echo $lang['left-menu-sidebar-7'] ?> </span>
										</a>
									</li>
							...
							<li class="sidebar-item">
								<a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)"
									aria-expanded="false"><i class="ti-package"></i>
									<span class="hide-menu"> <?php echo $lang['left-menu-sidebar-13'] ?></span>
								</a>
								<ul aria-expanded="false" class="collapse  first-level">

									<li class="sidebar-item">
										<a href="courier_add_client.php" class="sidebar-link"><i class="ti-package"
									...
									<li class="sidebar-item">
										<a href="courier_list.php" class="sidebar-link"><i class="mdi mdi-adjust"
												style="color:#fc3f7"></i>
											<span class="hide-menu"> <?php echo $lang['left-menu-sidebar-16'] ?> </span>
										</a>
									</li>
							...
							<!-- <li class="sidebar-item">
								...
								<ul aria-expanded="false" class="collapse  first-level">
									...
									<li class="sidebar-item">
										<a href="pickup_add.php" class="sidebar-link"><i class="mdi mdi-cube-send"
												style="color:#f62d51"></i>
											<span class="hide-menu"> <?php echo $lang['left-menu-sidebar-20'] ?> </span>
										</a>
									</li>
									...
									<li class="sidebar-item">
										<a href="pickup_list.php" class="sidebar-link"><i class="mdi mdi-adjust"
												style="color:#fc3f7"></i>
											<span class="hide-menu"> <?php echo $lang['left-menu-sidebar-21'] ?> </span>
										</a>
									</li>
							...
							<li class="sidebar-item">
								<a class="sidebar-link waves-effect waves-dark"
									href="customers_profile_edit.php?user=<?php echo $userData->id; ?>" aria-expanded="false"><i
			...
			<?php } else if ($userData->userlevel == 3) { ?>
							<ul id="sidebarnav">
								...
								<li class="p-15 m-t-10">
									<a href="courier_add.php"
										class="btn btn-block create-btn text-white no-block d-flex align-items-center">
										<i class="ti-package"></i> <span class="hide-menu m-l-5">
								<?php echo $lang['left-menu-sidebar-1'] ?> </span> </a>
								</li>
							...
							?>
								...
								<li class="sidebar-item">
									<a class="sidebar-link waves-effect waves-dark"
										href="drivers_edit.php?user=<?php echo $userData->id; ?>" aria-expanded="false">
