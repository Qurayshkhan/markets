				...
				<?php } else { ?>
					...
					foreach ($data as $row) {
						...
						<tr class="card-hovera">
							...
							<td><b><a
										href="courier_view.php?id=<?php echo $row->order_id; ?>"><?php echo $row->order_prefix . $row->order_no; ?></a></b>
							</td>
							...
							<td class="text-center">
								<?php echo $address_order->recipient_country; ?>-<?php echo $address_order->recipient_city; ?>
							</td>
								...
								<?php if ($row->status_courier != 14) { ?>
									<?php if ($row->status_invoice == 2) { ?>
										<?php if ($userData->userlevel == 1) { ?>
											...
											<a style="background: #34e89e;" class="label label"
							...
							<td class="">
								...
								<span style="background: <?php echo $row->color; ?>;"
									class="label label-large"><?php echo $row->mod_style; ?></span>
								<br>

								<?php
								if ($row->is_pickup == true) { ?>

									<span style="background: <?php echo $status_style_pickup->color; ?>;"
										class="label label-large"><?php echo $status_style_pickup->mod_style; ?></span>
									<?php
								}
								?>
								...
								if ($row->is_consolidate == true) { ?>
									...
									<span style="background: <?php echo $status_style_consolidate->color; ?>;"
										class="label label-large"><?php echo $status_style_consolidate->mod_style; ?></span>
									<?php
								}
								?>
